...
import { EmployeeTypesConfigModule } from "@/components/configuracion/employee-types-config-module"
import { Button } from "@/components/ui/button"
import { canAccessSettingsConfigWebModule } from "@/lib/roles/web-module-access"

export function EmployeeTypeAccessGuard({
  children,
}: {
...
export function EmployeeTypesConfigPage() {
  return (
    <EmployeeTypeAccessGuard>
      <EmployeeTypesConfigModule />
    </EmployeeTypeAccessGuard>
  )
}
