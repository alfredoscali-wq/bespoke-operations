...
function createPlanningPinIcon(color: string, highlighted: boolean): L.DivIcon {
  ...
  useEffect(() => {
    ...
    for (const markerEntry of markers) {
      ...
      if (existingMarker) {
        ...
        existingMarker.setIcon(createPlanningPinIcon(color, highlighted))
      ...
      const marker = L.marker(latLng, {
        icon: createPlanningPinIcon(color, highlighted),
