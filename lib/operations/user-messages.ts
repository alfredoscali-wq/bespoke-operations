...
export const TASK_ARCHIVE_BLOCKED_ACTIVE_MESSAGE =
  "No se puede archivar una orden de trabajo activa. Finalice, cierre o cancele la orden de trabajo antes de archivarla."
...
export const PROJECT_ARCHIVE_BLOCKED_ACTIVE_TASKS_MESSAGE =
  "No se puede archivar la obra. Existen órdenes de trabajo activas asociadas. Finalice, cierre o cancele todas las órdenes de trabajo antes de archivar la obra."
