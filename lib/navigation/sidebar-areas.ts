...
const PATH_AREA_PREFIXES: Array<{ prefix: string; area: SidebarAreaId }> = [
  ...
  { prefix: "/subscriptions", area: "customers" },
  ...
  { prefix: "/operations/mapa", area: "operations" },
  ...
  { prefix: "/configuracion/geolocalizacion", area: "system" },
