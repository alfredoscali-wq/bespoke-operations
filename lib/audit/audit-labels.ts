...
export const AUDIT_ACTION_LABELS: Record<AuditAction, string> = {
  ...
  FORCE_DELETE: "Eliminación forzada (Administrador)",
  PLANNING_CONFIRMED: "Planificación confirmada",
  TASK_MATERIAL_LINE_ADD: "Material agregado a OT",
  TASK_MATERIAL_LINE_UPDATE: "Material modificado en OT",
  TASK_MATERIAL_LINE_DELETE: "Material eliminado de OT",
  MATERIAL_RESERVATION_CREATED: "Reserva de material creada",
  MATERIAL_RESERVATION_UPDATED: "Reserva de material actualizada",
  MATERIAL_RESERVATION_RELEASED: "Reserva de material liberada",
  MATERIAL_CONSUMPTION_CREATED: "Consumo de material registrado",
  MATERIAL_RETURN_CREATED: "Devolución de material registrada",
