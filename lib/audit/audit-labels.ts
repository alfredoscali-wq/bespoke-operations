...
export const AUDIT_ACTION_LABELS: Record<AuditAction, string> = {
  ...
  TASK_CREATE: "OT creada",
  TASK_UPDATE: "OT editada",
  TASK_ASSIGN_CREW: "Cuadrilla asignada a OT",
  TASK_RESCHEDULE: "OT reprogramada",
  TASK_STATUS_VENCIDA: "OT marcada como Vencida",
  TASK_STATUS_EN_CURSO: "OT en curso",
  TASK_REQUEST_CLOSE: "Solicitud de cierre de OT",
  TASK_FINISH: "OT finalizada",
  TASK_CLOSE: "OT cerrada",
  TASK_DELETE: "OT eliminada",
  TASK_DELETE_PERMANENT: "OT eliminada definitivamente",
