...
export const AUDIT_ACTION_DEFINITIONS: Record<AuditAction, AuditActionDefinition> =
  {
    ...
    [AUDIT_ACTIONS.TASK_MATERIAL_LINE_ADD]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
    [AUDIT_ACTIONS.TASK_MATERIAL_LINE_UPDATE]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
    [AUDIT_ACTIONS.TASK_MATERIAL_LINE_DELETE]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
    [AUDIT_ACTIONS.MATERIAL_RESERVATION_CREATED]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
    [AUDIT_ACTIONS.MATERIAL_RESERVATION_UPDATED]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
    [AUDIT_ACTIONS.MATERIAL_RESERVATION_RELEASED]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
    [AUDIT_ACTIONS.MATERIAL_CONSUMPTION_CREATED]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
    [AUDIT_ACTIONS.MATERIAL_RETURN_CREATED]: {
      module: AUDIT_MODULES.TAREAS,
      entityType: AUDIT_ENTITY_TYPES.TASK,
      severity: AUDIT_SEVERITIES.INFO,
    },
