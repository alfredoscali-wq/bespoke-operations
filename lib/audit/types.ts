...
export const AUDIT_ACTIONS = {
  ...
  TASK_MATERIAL_LINE_ADD: "TASK_MATERIAL_LINE_ADD",
  TASK_MATERIAL_LINE_UPDATE: "TASK_MATERIAL_LINE_UPDATE",
  TASK_MATERIAL_LINE_DELETE: "TASK_MATERIAL_LINE_DELETE",
  MATERIAL_RESERVATION_CREATED: "MATERIAL_RESERVATION_CREATED",
  MATERIAL_RESERVATION_UPDATED: "MATERIAL_RESERVATION_UPDATED",
  MATERIAL_RESERVATION_RELEASED: "MATERIAL_RESERVATION_RELEASED",
  MATERIAL_CONSUMPTION_CREATED: "MATERIAL_CONSUMPTION_CREATED",
  MATERIAL_RETURN_CREATED: "MATERIAL_RETURN_CREATED",
