import type { WorkOrderImportReportRow } from "@/lib/tasks/work-order-import/types"
import * as XLSX from "xlsx"

export function buildImportReportCsv(reportRows: WorkOrderImportReportRow[]): Blob {
...
export function downloadImportReport(
  reportRows: WorkOrderImportReportRow[],
  format: "csv" | "xlsx",
  fileName = "reporte-importacion-ordenes"
) {
  const blob =
    format === "csv"
